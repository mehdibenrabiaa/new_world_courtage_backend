...
CATALOGS: dict[str, list[dict]] = {
    ...
    "garage": [
        ...
        {"key": "surface_risque", "section": "Risques", "type": "input", "input_type": "number",
         "question": "Surface du risque en m²", "products": ["protect_garage"]},
        {"key": "nombre_vehicules_detenus", "section": "Risques", "type": "input", "input_type": "number",
         "question": "Nombre de véhicules détenus simultanément", "products": ["negociants"]},
        {"key": "montant_vehicule_plus_cher", "section": "Risques", "type": "input", "input_type": "number",
         "question": "Montant du véhicule le plus cher", "placeholder": "Montant en €", "products": ["negociants"]},
        {"key": "valeur_moyenne_vehicule", "section": "Risques", "type": "input", "input_type": "number",
        ...
        {"key": "valeur_contenu", "section": "Risques", "type": "input", "input_type": "number", "required": False,
        ...
        {"key": "sinistres_hors_auto_montant", "section": "Antécédents", "type": "input", "input_type": "number", "required": False, "products": ["protect_garage"],
        ...
        {"key": "sinistres_auto_montant", "section": "Antécédents", "type": "input", "input_type": "number", "required": False, "products": ["protect_garage"],
         "question": "Montant / charge (auto)"},

        # — Flotte auto propre —
        {"key": "w_garage", "section": "Flotte auto propre", "type": "input", "input_type": "text",
         "question": "W Garage", "products": ["negociants", "protect_garage"]},
        ...
        {"key": "chiffre_affaires", "section": "Tarification", "type": "input", "input_type": "number",
